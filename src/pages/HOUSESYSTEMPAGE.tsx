  ...
  return (
    <div className="house-system-page">
      ...
      <main className="instance-parent8">
        <section className="home-contact-parent6">
          <div className="home-contact8">Home / House System</div>
          <div className="contact-us-wrapper4">
            <h1 className="contact-us8">House System</h1>
          </div>
          <img
            className="image-36-icon8"
            loading="lazy"
            alt=""
            src="/image-36@2x.png"
          />
