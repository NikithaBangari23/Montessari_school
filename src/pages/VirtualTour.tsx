  ...
  return (
    <div className="virtual-tour4">
      ...
      <main className="instance-parent1">
        <section className="home-contact-parent2">
          <div className="home-contact4">Home / Virtual Tour</div>
          <div className="contact-us-wrapper2">
            <h1 className="contact-us4">Virtual Tour</h1>
          </div>
          <img
            className="image-36-icon4"
            loading="lazy"
            alt=""
            src="/image-36@2x.png"
          />
