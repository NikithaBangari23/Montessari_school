  ...
  return (
    <div className="privacy-policy-page">
      ...
      <main className="instance-parent6">
        <section className="home-contact-parent5">
          <div className="home-contact7">Home / Privacy Policy</div>
          <div className="contact-us-wrapper3">
            <h1 className="contact-us7">Privacy Policy</h1>
          </div>
          <img
            className="image-36-icon7"
            loading="lazy"
            alt=""
            src="/image-36@2x.png"
          />
