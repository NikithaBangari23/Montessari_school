  ...
  return (
    <div className="event-detail-page">
      ...
      <main className="footer-container">
        <section className="home-contact-parent4">
          <div className="home-contact6">Home / Events/Event name</div>
          <div className="contact-label">
            <h2 className="contact-us6">Events Details</h2>
          </div>
          <img
            className="image-36-icon6"
            loading="lazy"
            alt=""
            src="/image-36@2x.png"
          />
